...
import com.aipuls.tool.utils.envcheck.CheckRoot
...
object FlowPermissionHelper {
    ...
    fun canBackgroundStart(context: Context): Boolean {
        if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.N_MR1 || com.aipuls.tool.utils.envcheck.CheckRoot.isDeviceRooted()) {
            return true
        }
